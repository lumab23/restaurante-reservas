...
INSERT INTO Admin (nome, email, senha, cargo, ativo) VALUES 
...
-- Inserir alguns itens no cardápio
INSERT INTO Cardapio (nome, descricao, preco) VALUES 
('Filé à Parmegiana', 'Filé empanado com molho de tomate e queijo derretido', 45.90),
('Risoto de Cogumelos', 'Risoto cremoso com mix de cogumelos frescos', 38.50),
('Salada Caesar', 'Alface romana, croutons, parmesão e molho caesar', 32.90),
('Salmão Grelhado', 'Filé de salmão grelhado com legumes e arroz', 52.90),
('Tiramisù', 'Sobremesa italiana com café, mascarpone e cacau', 24.90); 